...
class Curvey extends StatefulWidget {

  @override
  _CurveyState createState() => _CurveyState();
}

class _CurveyState extends State<Curvey> with TickerProviderStateMixin{
  double paintHeight = 500.0;
  bool isBright = false;
  bool isOpened = false;
  double biggerTextSize = 50.0;
  double smallerTextSize = 30.0;
        ...
        children: [
          CustomPaint(
            ...
            painter: CurvePainter(
              colorOne: Color(0xff1a4ff7),
              colorTwo: Theme.of(context).primaryColor.withOpacity(.3),
              colorThree: Theme.of(context).primaryColor.withOpacity(.7),
            ),
          ),
        ],
      ),
...
class CurvePainter extends CustomPainter{
  ...
  final Color colorOne; //= Colors.red;
  final Color colorTwo; //= Colors.red[300];
  final Color colorThree;// = Colors.red[100];
  ...
  path.quadraticBezierTo(size.width*0.10, size.height*0.95, size.width*0.35, size.height*0.80);
  ...
  path.quadraticBezierTo(size.width*0.10, size.height*0.55, size.width*0.17, size.height*0.68);
