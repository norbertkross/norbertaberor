    ...
    return Center(
      child: SizedBox(
        ...
        child: Stack(
          children: [
            Padding(
              padding: mq.width > 800
                  ? EdgeInsets.only(left: cardWidth * .70, right: 30.0)
                  : EdgeInsets.only(top: 260.0),
              child: Column(
                children: [
                  SizedBox(
                    width: mq.width,
                      ...
                      children: [
                        Container(
                          ...
                          child: Padding(
                            padding: mq.width > 800
                                ? EdgeInsets.only(
                                    left: (cardWidth * .30) + 10.0)
                                : EdgeInsets.all(0.0),
                            child: SizedBox(
                              //color: Colors.redAccent,
                              child: Column(
                                crossAxisAlignment: mq.width > 800
                                    ? CrossAxisAlignment.start
                                    : CrossAxisAlignment.center,
                                children: [
                                  SizedBox(
                                    height:
                                        mq.width > 1080 ? mq.width * .05 : 40.0,
                                  ),

                                  SizedBox(
                                    height: mq.width <= 800 ? 10.0 : 0.0,
                                  ),
                                  ...
                                  Padding(
                                    padding: mq.width > 800
                                        ? EdgeInsets.symmetric(
                                            horizontal: containerWidth * .20)
                                        : EdgeInsets.all(10.0),
                                    child: Text(
                                      "I like to think of myself as a problem solver, looking forward to build real,great products that solve some of the problems our societies face. I enjoy meeting new people and finding ways to help them have an uplifting experince. I am a passionate developer who love to write code to solve problems.",
                                  ...
                                  SizedBox(
                                    height:
                                        mq.width > 1080 ? mq.width * .07 : 40.0,
                                  ),
                                ],
                              ),
                            ),
                      ...
                      Padding(
                        ...
                        child: Card(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius:
                                  BorderRadius.circular(pictureBorder),
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: AssetImage(
                                      "assets/uis/IMG_20201205_164357_294.jpg")),
                            ),
                          ),
                        ),
                      ),
